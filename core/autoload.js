                ...
                function self(namespace){
                                   ...
                                   if(this=="undefined"){
                                       ...
                                       return function(args){
                                            ...
                                            console.log(args);
                                            return  new (thatclass.fn.bind({},args))(); ///// TO DO ARGS
                                       };
                                   }
                 }
        ...
        typeValidator(a,type){
            switch(type){
                default:
                    ...
                    break;
                case "string":
                     if(a.constructor !== String){  throw `ERROR ${a} NOT A string`}
                  break;
               case "number":
               case "int":
                     if(a.constructor !== Number){  throw `ERROR ${a} NOT A Number`}
                  break;
               case "boolean":
                     if(a.constructor !== Boolean){ throw `ERROR ${a} NOT A Boolean`}
                  break;  
               case "object":
                     if(a.constructor !== Object){  throw `ERROR ${a} NOT A Object`}
                  break;    
               case "array":
                     if(a.constructor !== Array){  throw `ERROR ${a} NOT A Array`}
                  break;    
            }
            return true;
